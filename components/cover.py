...
def render_cover(guest_name="Bapak/Ibu/Saudara/i"):
    ...
    # Ambil nilai ornamen terlebih dahulu
    ornament = create_ornament()
    
    # KUNCI: HTML ditulis rata kiri semua tanpa enter berlebih 
    # agar Streamlit tidak menganggapnya sebagai Markdown Code Block
    html_content = f"""
...
<div style="margin: 1.5rem 0;">{ornament}</div>
